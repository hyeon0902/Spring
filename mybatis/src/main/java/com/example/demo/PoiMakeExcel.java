...
public class PoiMakeExcel {
    ...
    public static void main(String[] args) {
        ...
        data.put("2", new Object[]{"1", "나채현", "010-1111-1111"});
        data.put("3", new Object[]{"2", "김재현", "010-2222-2222"});
        data.put("4", new Object[]{"3", "채현", "010-3333-3333"});
        data.put("5", new Object[]{"4", "현", "010-4444-4444"});
        data.put("5", new Object[]{"4", "test", "010-4444-4444"});
